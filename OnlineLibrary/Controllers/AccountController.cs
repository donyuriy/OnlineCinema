...
namespace OnlineLibrary.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {            
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    return RedirectToAction("AddUser", "Account", model);                                   //редирект на экшн AddUser
                }
        ...
        {
            User u = new Models.User() { FirstName = model.FirstName, LastName = model.LastName, Birthday = model.Birthday, Email = model.Email };
            db.User.Add(u);
            db.SaveChanges();
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserProfile user = db.UserProfiles.FirstOrDefault(u => u.Login.ToLower() == model.Login.ToLower());
        ...
        public ActionResult RemoveExternalLogins()
        {
            ...
            foreach (OAuthAccount account in accounts)
            {
                ...
                externalLogins.Add(new ExternalLogin
                {
                    ...
                    ProviderUser_Id = account.ProviderUserId,
                });
            }
